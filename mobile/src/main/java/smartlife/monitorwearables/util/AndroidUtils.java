...
public class AndroidUtils {
    ...
    public static long parseMongoDateToLocal(String date){
        try {
            ...
            int offsetInMilliseconds = TimeZone.getDefault().getOffset(format.parse(date).getTime());
            long parsedDateInMiliseconds = format.parse(date).getTime() + offsetInMilliseconds;
            return parsedDateInMiliseconds;
