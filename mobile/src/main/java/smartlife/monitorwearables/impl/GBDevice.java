...
import smartlife.monitorwearables.model.BatteryState;
import smartlife.monitorwearables.model.DeviceType;
import smartlife.monitorwearables.model.ItemWithDetails;

public class GBDevice implements Parcelable {
    public static final String ACTION_DEVICE_CHANGED
            = "wearable.hrmonitor.gbdevice.action.device_changed";
